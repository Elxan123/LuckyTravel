<?php
 class ToursWebPageCoding extends CI_Controller{
     ...
     public function load_data()
     {
         ...
         if (!empty($search_value) && !empty($date_value)){
         ...
         }elseif (!empty($search_value) && empty($date_value)){
         ...
         }elseif (!empty($date_value) && empty($search_value)){
...
//         paginationda rowlarin sayilmasi
         ...
         elseif(!empty($this->session->userdata("search_value")) || !empty($this->session->userdata("date_value"))){

             if (!empty($this->session->userdata("search_value")) && !empty($this->session->userdata("date_value"))){
...
//         filterasiyaya uygun datanin getirilmesi
         ...
         if (!empty($this->session->userdata("search_value")) || !empty($this->session->userdata("date_value"))){
             ...
             if (empty($this->session->userdata("date_value"))){
                 ...
                 $data['tours'] = $this->Core->get_date_pagination($this->session->userdata("date_value"), $config["per_page"], $page, $this->table_name);
             }else{
                 $data['tours'] = $this->Core->get_search_pagination_date($this->session->userdata("date_value") , $this->session->userdata("search_value"), $config["per_page"], $page, $this->table_name);
             }
